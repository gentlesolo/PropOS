...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { background: {{ $listing->agency->primary_color ?? '#10B981' }}; color: #fff; padding: 32px 40px; }
        ...
        .stat-value { font-size: 24px; font-weight: 800; color: {{ $listing->agency->primary_color ?? '#10B981' }}; }
        .stat-label { font-size: 10px; color: #6B7280; margin-top: 3px; font-weight: 500; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 6px; }
        ...
        .narrative-box { background: #F9FAFB; border-left: 4px solid {{ $listing->agency->primary_color ?? '#10B981' }}; border-radius: 0 6px 6px 0; padding: 16px 20px; font-size: 12px; line-height: 1.7; color: #374151; }
        ...
        .health-bar-fill { height: 8px; border-radius: 4px; background: {{ $listing->agency->primary_color ?? '#10B981' }}; }
...
<div class="content">
    ...
    <div class="section">
        ...
        <table class="property-table" width="100%">
            ...
            <tr><td>Listing Price</td><td style="color:{{ $listing->agency->primary_color ?? '#10B981' }};font-size:14px;">{{ number_format((float) $listing->listing_price) }}</td></tr>

        ...
        <form wire:submit.prevent="uploadDocument" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2 flex gap-3">
                ...
                <button type="button" wire:click="$set('showUploadForm', false)"
                    class="px-5 py-2 bg-surface-hover text-text-secondary rounded-xl text-sm font-medium hover:text-text-primary transition-colors">
                    Cancel
                </button>
            </div>
        </form>
                    ...
                    <td class="px-4 py-3">
                        <div class="flex items-center justify-end gap-2">
                            ...
                            <button wire:click="approveDocument({{ $doc->id }})"
                                class="text-xs text-success-600 hover:underline font-medium">Approve</button>
                            @endif
                            <button wire:click="deleteDocument({{ $doc->id }})"
                                wire:confirm="Delete this document permanently?"
                                class="text-xs text-danger-500 hover:underline font-medium">Delete</button>
                        </div>
                    </td>
                </tr>
                @empty

            ...
            <form wire:submit.prevent="createExpense" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2 flex gap-3">
                    <button type="submit" wire:loading.attr="disabled"
                        class="px-5 py-2 bg-brand-primary text-white rounded-xl text-sm font-medium hover:bg-brand-hover transition-colors">Submit for Approval</button>
        ...
        <div class="p-5">
            ...
            <div class="space-y-2 mt-4">
                ...
                @elseif($detailExpense->status === 'approved')
                    <button wire:click="markPaid({{ $detailExpense->id }})" class="w-full py-2 bg-brand-primary text-white rounded-xl text-sm font-medium hover:bg-brand-hover transition-colors">Mark as Paid</button>

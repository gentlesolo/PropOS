<div>
    ...
    {{-- Create Form --}}
    @if($showCreateForm)
    <div class="bg-surface-card rounded-2xl border border-brand-primary/30 p-5 mb-6">
        ...
        <form wire:submit.prevent="createReminder" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <select wire:model="reminder_type" class="w-full rounded-lg border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:ring-offset-2 focus:ring-offset-surface-page">
    ...
    <div class="space-y-3">
        ...
        @endphp
        <div class="bg-surface-card rounded-2xl border {{ $borderColor }} p-4 flex flex-col md:flex-row md:items-center gap-3">

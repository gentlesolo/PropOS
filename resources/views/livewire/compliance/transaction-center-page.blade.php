<div>
    ...
    <div class="bg-surface-card rounded-2xl border border-warning-200 bg-warning-50/50 p-5 mb-6">
    ...
    <!-- Tabs -->
    <div class="flex border-b border-border-default mb-6 gap-1">
    ...
    <div class="space-y-4">
        ...
        <div class="bg-surface-card border border-border-default rounded-2xl p-5 shadow-sm hover:shadow transition-shadow">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-5 items-center">
                ...
                <div class="lg:col-span-2 text-right">
                    <a href="{{ route('compliance.transaction.detail', $transaction) }}"
                        class="px-4 py-2 bg-gradient-to-br from-brand-primary to-brand-primary/80 text-white shadow-brand-sm ring-1 ring-white/10 rounded-xl text-sm font-bold hover:bg-brand-secondary transition-colors hover-spring active:scale-95 inline-block">
                        Manage
                    </a>
                </div>
            </div>

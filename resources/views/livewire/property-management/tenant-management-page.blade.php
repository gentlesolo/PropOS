<div>
    ...
    <div class="bg-surface-card rounded-2xl border border-brand-200 p-5 mb-6">
        ...
        <form wire:submit.prevent="createTenant" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <select wire:model="status" class="w-full rounded-lg border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:ring-offset-2 focus:ring-offset-surface-page">
            ...
            <div>
                ...
                <input wire:model="employer" type="text" class="w-full rounded-lg border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:ring-offset-2 focus:ring-offset-surface-page">
            </div>
            <div>
                <label class="block text-xs font-medium text-text-secondary mb-1">Monthly Income ({{ $currencySymbol }})</label>
                <input wire:model="monthly_income" type="number" min="0" class="w-full rounded-lg border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:ring-offset-2 focus:ring-offset-surface-page">
            </div>
            <div>
    ...
    <div class="bg-surface-card rounded-2xl border border-warning-200 p-5 mb-6">
        ...
        <form wire:submit.prevent="saveEdit" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label class="block text-xs font-medium text-text-secondary mb-1">Status *</label>
                <select wire:model="edit_status" class="w-full rounded-lg border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:ring-offset-2 focus:ring-offset-surface-page">
            ...
            <div>
                <label class="block text-xs font-medium text-text-secondary mb-1">Employer</label>
                <input wire:model="edit_employer" type="text" class="w-full rounded-lg border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:ring-offset-2 focus:ring-offset-surface-page">
            </div>
            <div>
                <label class="block text-xs font-medium text-text-secondary mb-1">Monthly Income ({{ $currencySymbol }})</label>
                <input wire:model="edit_monthly_income" type="number" min="0" class="w-full rounded-lg border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:ring-offset-2 focus:ring-offset-surface-page">
            ...
            <div class="md:col-span-2">
                ...
                <textarea wire:model="edit_notes" rows="2" class="w-full rounded-lg border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:ring-offset-2 focus:ring-offset-surface-page"></textarea>
            </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div>
            @if($selectedTenant)
            <div class="bg-surface-card rounded-2xl border border-border-default overflow-hidden sticky top-6">
                ...
                <div class="p-4">
                    ...
                    <form wire:submit.prevent="uploadFica" class="space-y-3">
                        ...
                        <button type="submit" wire:loading.attr="disabled"
                            class="w-full py-2 bg-gradient-to-br from-brand-primary to-brand-primary/80 text-white shadow-brand-sm ring-1 ring-white/10 rounded-xl text-xs font-medium hover:bg-brand-hover transition-colors">Upload Document</button>
                    </form>

<div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-6 gap-4 mb-8">
        ...
        <div class="bg-surface-card p-4 rounded-2xl border border-border-default text-center">
    ...
    <!-- Create Form -->
    @if($showCreateForm)
    <div class="bg-surface-card rounded-2xl border border-brand-primary/20 bg-brand-primary/5 p-6 mb-6">
        ...
        <form wire:submit.prevent="createCampaign" class="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <select wire:model.defer="objective" class="w-full rounded-xl border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:ring-offset-2 focus:ring-offset-surface-page">
            ...
            <div>
                ...
                <input wire:model.defer="budget_daily" type="number" min="500" class="w-full rounded-xl border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:ring-offset-2 focus:ring-offset-surface-page">
            ...
            <div>
                ...
                <input wire:model.defer="start_date" type="date" class="w-full rounded-xl border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:ring-offset-2 focus:ring-offset-surface-page">
            </div>
            <div>
                <label class="block text-xs font-medium text-text-secondary mb-1">End Date</label>
                <input wire:model.defer="end_date" type="date" class="w-full rounded-xl border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:ring-offset-2 focus:ring-offset-surface-page">
            </div>
            <div class="md:col-span-2">

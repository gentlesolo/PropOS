    ...
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="p-8 bg-slate-900/60 rounded-3xl border border-slate-800 backdrop-blur-md space-y-6">
            ...
            <form wire:submit.prevent="submitRsvp" class="space-y-4">
                ...
                <button type="submit" class="w-full py-4 bg-brand-primary hover:bg-brand-secondary text-white font-semibold text-sm rounded-xl transition shadow-lg shadow-brand-primary/20">
                    Register RSVP
                </button>
            </form>
        </div>

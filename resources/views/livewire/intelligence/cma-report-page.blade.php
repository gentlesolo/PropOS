    ...
    <div class="glass-panel rounded-2xl border border-border-default/60 p-5 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div class="md:col-span-2">
                ...
                <input wire:model="title" type="text" class="w-full rounded-lg border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary" placeholder="CMA — 45 Oak Avenue, Sandton">
            ...
            <div class="md:col-span-2">
                ...
                <input wire:model="subject_address" type="text" class="w-full rounded-lg border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary">
            ...
            <div class="md:col-span-2">
                ...
                <textarea wire:model="summary" rows="3" class="w-full rounded-lg border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary resize-none" placeholder="Market context, key findings, recommendation…"></textarea>
            </div>
        </div>
        ...
        <div class="border-t border-border-default pt-4 mb-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-2 mt-2">
                <input wire:model="comp_address" type="text" placeholder="Address *" class="md:col-span-2 rounded-lg border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary">
                <input wire:model="comp_sale_price" type="number" placeholder="Sale Price *" class="rounded-lg border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary">
                <input wire:model="comp_sale_date" type="date" class="rounded-lg border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary">
        ...
        <div class="flex gap-3">
            <button wire:click="generate" class="px-5 py-2 bg-brand-primary text-white rounded-xl text-sm font-medium hover:bg-brand-secondary transition-colors">

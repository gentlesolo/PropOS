<div>
    ...
    <div class="flex gap-1 border-b border-border-default mb-6">
        ...
        <button wire:click="$set('scoringTab', '{{ $tab }}')"
            ...
            {{ $scoringTab === $tab ? 'border-brand-primary text-brand-primary' : 'border-transparent text-text-secondary hover:text-text-primary' }}" wire:loading.attr="disabled" wire:target="$set">

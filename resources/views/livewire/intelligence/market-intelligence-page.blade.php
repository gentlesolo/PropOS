<div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div class="bg-surface-card p-5 rounded-2xl border border-border-default">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div class="bg-surface-card rounded-2xl border border-border-default p-5 sticky top-6">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <select wire:model.defer="area" class="w-full rounded-xl border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:ring-offset-2 focus:ring-offset-surface-page">
                    ...
                    <div>
                        ...
                        <select wire:model.defer="propertyType" class="w-full rounded-xl border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:ring-offset-2 focus:ring-offset-surface-page">
                    ...
                    <div>
                        ...
                        <select wire:model.defer="reportPeriod" class="w-full rounded-xl border border-border-default bg-surface-input px-3 py-2 text-sm text-text-primary focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:ring-offset-2 focus:ring-offset-surface-page">
                            <option value="30">Last 30 Days</option>
                            <option value="60">Last 60 Days</option>
                            <option value="90">Last 90 Days</option>
                        </select>
                    </div>
                    <button wire:click="generateReport" class="w-full py-2.5 bg-gradient-to-br from-brand-primary to-brand-primary/80 text-white shadow-brand-sm ring-1 ring-white/10 rounded-xl font-bold text-sm hover:bg-brand-secondary transition-colors hover-spring active:scale-95 flex items-center justify-center gap-2">
        ...
        <div class="xl:col-span-2">
            ...
            <div class="space-y-5">
                ...
                <!-- Summary -->
                <div class="bg-surface-card rounded-2xl border border-brand-primary/20 bg-brand-primary/5 p-6">
                ...
                <!-- Recommendations -->
                <div class="bg-surface-card rounded-2xl border border-success-200 bg-success-50/40 p-5">

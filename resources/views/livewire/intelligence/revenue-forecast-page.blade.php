<div>
    <div class="flex items-center justify-between mb-8">
        ...
        <div class="flex items-center gap-3">
            <button wire:click="$toggle('showScenario')" class="disabled:opacity-70 disabled:cursor-not-allowed relative px-4 py-2 border border-brand-primary/40 text-brand-primary rounded-xl text-sm font-bold hover:bg-brand-primary/5 transition-colors" wire:loading.attr="disabled" wire:target="$toggle">
                <span wire:loading.remove wire:target="$toggle">{{ $showScenario ? 'Hide Scenario' : '?? Scenario Planner' }}</span>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="lg:col-span-2 bg-surface-card rounded-2xl border border-border-default p-8 shadow-sm relative overflow-hidden">
        ...
        <div class="flex flex-col gap-4">
            <div class="bg-surface-card rounded-2xl border border-border-default p-5 flex items-center gap-4">
            ...
            <div class="bg-surface-card rounded-2xl border border-brand-primary/20 bg-brand-primary/5 p-5 flex-1">
                ...
                <button wire:click="generateInsights" class="w-full py-2 bg-gradient-to-br from-brand-primary to-brand-primary/80 text-white shadow-brand-sm ring-1 ring-white/10 rounded-xl text-xs font-bold hover:bg-brand-secondary transition-colors">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-surface-card rounded-2xl border border-border-default p-5 hover:border-brand-primary/40 transition-colors">

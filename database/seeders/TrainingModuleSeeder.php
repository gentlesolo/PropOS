...
class TrainingModuleSeeder extends Seeder
{
    public function run(): void
    {
        $modules = [
            ...
            [
                'title' => 'PropOS AI Features Deep Dive',
                'category' => 'tools',
                'type' => 'guide',
                'duration' => '8m read',
